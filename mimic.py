...
from utils import quaternion_to_rotation_6d, deserialize_qp


class Mimic(env.Env):
    """Trains a humanoid to mimic reference motion."""

    def __init__(self, system_config, reference_traj, obs_type, cyc_len):
